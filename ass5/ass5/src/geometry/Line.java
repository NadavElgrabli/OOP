 ...
 * about a line, and constructors of the object Geometry.Line.
 */
...
public class Line {
    ...
    /**
     * Constructor name: Geometry.Line
     * Input: two Points, start and end
     * Output: void.
     * Constructor Operation: gives the start point and end point of the line.
     *
     * @param start is the start Geometry.Point.
     * @param end   is the end Geometry.Point.
     */
     ...
     *
     * @return middle Geometry.Point of the line.
     */
    public Point middle() {
