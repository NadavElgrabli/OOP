 ...
 * Class creates a Movement.Velocity that specifies the change in position on the `x` and the `y` axes.
 */
public class Velocity {
    ...
    /**
     * Constructor name: Movement.Velocity.
     * Input: double dx, double dy.
     * Output: Creates velocity.
     * Constructor operation: Creates Movement.Velocity.
     ...
     * @param p is the given Geometry.Point
